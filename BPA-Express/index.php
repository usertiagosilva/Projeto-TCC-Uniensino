            ...
            <header>
                <nav class="header-content container">
                    ...
                    <div class="header-logo" data-aos="fade-up" data-aos-delay="350">
                        <img src="img/default_transparent_765x625.png" alt="Logo BPA EXPRESS" data-aos="flip-up" data-aos-duration="1500" data-aos-delay="400">
                    </div>
        ...
        <section class="about">
            <div class="container about-content">
                <div data-aos="zoom-in" data-aos-delay="100">
                    <img src="img/entregas.png" alt="BPA EXPRESS">
                </div>
                ...
                <p>A BPA Express é uma empresa de transporte logístico com uma abordagem moderna e eficiente, garantindo agilidade, segurança e pontualidade em todas as entregas.
                    ...
                    <p>Na BPA Express, acreditamos que cada entrega é uma oportunidade de construir relacionamentos sólidos e duradouros. Estamos prontos para transportar suas mercadorias com o máximo cuidado e precisão.
                    </p><br>
    ...
    <!-- Services -->
        <section class="services">
            <div class="services-content container">
                ...
                <p>Na BPA EXPRESS, oferecemos soluções de transporte para atender às suas necessidades logísticas. Garantimos eficiência, segurança e agilidade em cada serviço prestado. Nossos serviços:</p>
            </div>
            <section class="our-services">
                <div class="service" data-aos="fade-up" data-aos-delay="150">
                    <img src="img/coletas.webp" alt="Coletas">
                    <div class="service-info">
                        <strong>Coletas</strong>
                    </div>
                </div>
                <div class="service" data-aos="fade-up" data-aos-delay="300">
                    <img src="img/entregas.png" alt="Entregas">
                    <div class="service-info">
                        <strong>Entregas</strong>
                    </div>
                </div>
                <div class="service" data-aos="fade-up" data-aos-delay="500">
                    <img src="img/fretes.png" alt="Fretes">
                    <div class="service-info">
 ...
 <section class="freight-calculator">
        <div class="container">
            ...
            <form id="freightForm">
                <div class="form-group">
                    ...
                    <input type="text" id="pickupAddress" name="pickup" placeholder="CEP de origem" required>
                </div>
                <div class="form-group">
                    <label for="destino">Destino</label>
                    <input type="text" id="deliveryAddress" name="delivery" placeholder="CEP de destino" required>
                </div>
                <div class="form-group">
    ...
    <footer class="footer">
        ...
        <div class="footer-logo">
            <img src="img/default_transparent_765x625.png" alt="Logo Transportadora">
        </div>
    ...
    <a href="https://api.whatsapp.com/send?phone=041999905296&text=Quero%20fazer%20um%20orçamento!" class="btn-whatsapp" target="_blank" data-aos="zoom-in-up" data-aos-delay="250">
        <img src="img/whatsapp.png" alt="Botao whatsapp">
